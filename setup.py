...
PACKAGENAME = metadata.get('package_name', 'uvot-galphot')
DESCRIPTION = metadata.get('description', 'photometry of UVOT galaxy images')
AUTHOR = metadata.get('author', 'Lea Hagen')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: uvot-galphot requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
